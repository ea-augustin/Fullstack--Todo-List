<link rel="stylesheet" href="css/main.css" xmlns="http://www.w3.org/1999/html">
<footer>
<div class="container">
...
<footer class="page-footer font-small special-color-dark pt-4">
    ...
    <div class="container">
        ...
        <ul class="list-unstyled list-inline text-center">
            <li class="list-inline-item">
                <img src="./img/logo_fb.png" alt="Facebook" class="rounded logo-social">
            </li>
            <li class="list-inline-item">
                <img src="./img/logo_tweeter.png" alt="twitter" class="rounded logo-social">
            </li>
            <li class="list-inline-item">
                <img src="./img/logo_instagram.png" alt="instagram" class="rounded logo-social">
    ...
    <div class="footer-copyright text-center py-3">© 2018 Copyright:
        <a href="https://mdbootstrap.com/education/bootstrap/">The never list</a>
    </div>
    <!-- Copyright
